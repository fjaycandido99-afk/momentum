  ...
  if (insights.totalEntries < 3) {
    return (
      <div className="glass-refined rounded-2xl p-4">
        ...
        <p className="text-xs text-white/40">Log your mood at least 3 times to see insights</p>
      </div>
    )
  }
    ...
    <div className="glass-refined rounded-2xl p-4">
      ...
      <div className="grid grid-cols-3 gap-2 mb-3">
        <div className="p-2 rounded-xl bg-white/[0.03] text-center">
          ...
          <p className="text-[9px] text-white/40">Avg Mood</p>
        ...
        <div className="p-2 rounded-xl bg-white/[0.03] text-center">
          ...
          <p className="text-[9px] text-white/40">30d Trend</p>
        </div>
        <div className="p-2 rounded-xl bg-white/[0.03] text-center">
          <p className="text-lg font-bold text-blue-400">{insights.totalEntries}</p>
          <p className="text-[9px] text-white/40">Entries</p>
        </div>
      </div>
      ...
      {insights.weeklyBreakdown.length > 0 && (
        <div className="mt-3">
          <p className="text-[10px] text-white/30 mb-2">Weekly Pattern</p>
          <div className="flex items-end gap-1 h-10">
            {insights.weeklyBreakdown.map(d => (
              <div key={d.day} className="flex-1 flex flex-col items-center gap-0.5">
                ...
                />
                <span className="text-[7px] text-white/30">{d.day.slice(0, 2)}</span>
              </div>
            ))}
          </div>
        </div>
