...
export function ShareButton({ title, text, url, className = '', size = 'md' }: ShareButtonProps) {
  ...
  return (
    <div ref={containerRef} className="relative inline-block">
      ...
      {showDropdown && (
        <div className="absolute right-0 bottom-full mb-2 z-50 bg-[#1c1c20] border border-white/15 rounded-xl shadow-xl overflow-hidden min-w-[180px] animate-in fade-in slide-in-from-bottom-2 duration-200">
          <a
