...
export const QuoteShareCard = forwardRef<HTMLDivElement, QuoteShareCardProps>(
  function QuoteShareCard({ quote, author, mindset }, ref) {
    return (
      <div
        ref={ref}
        className="w-[360px] p-8 bg-gradient-to-br from-[#0a0a0f] to-[#1a1a2e] rounded-2xl border border-white/10"
      ...
      >
        ...
        {/* Author */}
        {author && (
          <p className="text-white/50 text-sm mt-4 font-sans" style={{ fontFamily: 'Inter, sans-serif' }}>
            &mdash; {author}
          </p>
        )}

        {/* Footer */}
        <div className="mt-6 pt-4 border-t border-white/10 flex items-center justify-between" style={{ fontFamily: 'Inter, sans-serif' }}>
