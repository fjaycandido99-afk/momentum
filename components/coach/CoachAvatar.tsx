  ...
  return (
    <OutfitLayout
      ...
      onHead={
        <>
          {/* Sideburns */}
          <path d="M18 56 L14 68 Q16 72 20 68 L22 58 Z" fill="black" opacity="0.9" />
          <path d="M82 56 L86 68 Q84 72 80 68 L78 58 Z" fill="black" opacity="0.9" />
          {/* Full mustache — thick handlebar */}
          <path d="M32 64 Q36 60 42 62 Q46 58 50 62 Q54 58 58 62 Q64 60 68 64 Q72 66 74 64 L74 68 Q68 72 64 68 Q58 66 50 68 Q42 66 36 68 Q32 72 26 68 L26 64 Q28 66 32 64 Z" fill="black" opacity="0.9" />
          {/* Main beard body */}
          <path d="M26 68 Q28 66 36 68 Q42 66 50 70 Q58 66 64 68 Q72 66 74 68 L76 74 Q72 86 50 94 Q28 86 24 74 Z" fill="black" opacity="0.9" />
          {/* Beard texture lines */}
          ...
          <circle cx="50" cy="24" r="4" fill="black" opacity="0.9" />
          <circle cx="50" cy="24" r="2" fill={BOT.body} opacity="0.25" />
          {/* Laurel leaves at temples */}
          <path d="M20 30 Q16 26 18 22 Q22 24 20 30 Z" fill="black" opacity="0.85" />
          <path d="M18 34 Q14 30 16 26 Q20 28 18 34 Z" fill="black" opacity="0.8" />
          <path d="M80 30 Q84 26 82 22 Q78 24 80 30 Z" fill="black" opacity="0.85" />
          <path d="M82 34 Q86 30 84 26 Q80 28 82 34 Z" fill="black" opacity="0.8" />
        </>
      }
    />
  )
  ...
  return (
    <OutfitLayout
      ...
      onHead={
        <>
          {/* Beret on top */}
          <path d="M22 20 Q24 8 50 6 Q76 8 78 20 Q74 16 50 14 Q26 16 22 20 Z" fill="black" opacity="0.9" />
          <ellipse cx="50" cy="14" rx="28" ry="10" fill="black" opacity="0.9" />
          <circle cx="50" cy="6" r="2.5" fill="black" opacity="0.9" />
          {/* Beret texture */}
          ...
          <circle cx="36" cy="53" r="15" fill="black" opacity="0.9" />
          {/* Right lens — fully solid */}
          <circle cx="64" cy="53" r="15" fill="black" opacity="0.9" />
          {/* Lens shine marks */}
          ...
          <path d="M49 48 Q50 44 51 48 L53 56 L47 56 Z" fill="black" opacity="0.9" />
          {/* Temple arms with hinges */}
          <rect x="4" y="50" width="17" height="4" rx="1.5" fill="black" opacity="0.9" />
          <rect x="79" y="50" width="17" height="4" rx="1.5" fill="black" opacity="0.9" />
          <circle cx="20" cy="52" r="1.5" fill="black" opacity="0.9" />
          <circle cx="80" cy="52" r="1.5" fill="black" opacity="0.9" />
    ...
    <OutfitLayout
      ...
      onHead={
        <>
          ...
          <path d="M28 18 L32 16 L36 -4 L40 14 L44 -8 L48 12 L50 -12 L52 12 L56 -8 L60 14 L64 -4 L68 16 L72 18 Q66 16 50 16 Q34 16 28 18 Z" fill="black" opacity="0.9" />
          {/* Mohawk base band */}
          <rect x="28" y="14" width="44" height="6" rx="3" fill="black" opacity="0.9" />
          {/* Hair texture lines */}
          ...
          <path d="M62 24 L66 24 L74 60 L70 60 Z" fill="black" opacity="0.85" />
          ...
          <circle cx="24" cy="36" r="2" fill="black" opacity="0.9" />
          <circle cx="24" cy="36" r="0.8" fill={BOT.body} opacity="0.3" />
          {/* Chin stud */}
          <circle cx="50" cy="76" r="2" fill="black" opacity="0.85" />
    ...
    <OutfitLayout
      ...
      onHead={
        <g>
          ...
          {/* Vine base */}
          <path d="M18 22 Q30 12 42 14 Q46 10 50 12 Q54 10 58 14 Q70 12 82 22" fill="black" opacity="0.85" stroke="black" strokeWidth="2" />
          {/* Leaves between flowers */}
          <path d="M30 18 Q28 14 32 12 Q34 16 30 18 Z" fill="black" opacity="0.9" />
          <path d="M42 14 Q40 10 44 8 Q46 12 42 14 Z" fill="black" opacity="0.9" />
          <path d="M58 14 Q56 10 60 8 Q62 12 58 14 Z" fill="black" opacity="0.9" />
          <path d="M70 18 Q68 14 72 12 Q74 16 70 18 Z" fill="black" opacity="0.9" />
          {/* Flower 1 — with petals */}
          <circle cx="22" cy="20" r="3" fill="black" opacity="0.9" />
          <ellipse cx="18" cy="18" rx="3" ry="1.8" fill="black" opacity="0.9" transform="rotate(-30 18 18)" />
          <ellipse cx="26" cy="18" rx="3" ry="1.8" fill="black" opacity="0.9" transform="rotate(30 26 18)" />
          <ellipse cx="22" cy="16" rx="1.8" ry="3" fill="black" opacity="0.9" />
          <circle cx="22" cy="20" r="1.5" fill={BOT.body} opacity="0.25" />
          {/* Flower 2 — rose shape */}
          <circle cx="36" cy="14" r="4" fill="black" opacity="0.9" />
          ...
          <circle cx="50" cy="10" r="5" fill="black" opacity="0.9" />
          <ellipse cx="46" cy="8" rx="3" ry="2" fill="black" opacity="0.9" transform="rotate(-20 46 8)" />
          <ellipse cx="54" cy="8" rx="3" ry="2" fill="black" opacity="0.9" transform="rotate(20 54 8)" />
          <ellipse cx="50" cy="6" rx="2" ry="3" fill="black" opacity="0.9" />
          <circle cx="50" cy="10" r="2" fill={BOT.body} opacity="0.2" />
          {/* Flower 4 — rose shape */}
          <circle cx="64" cy="14" r="4" fill="black" opacity="0.9" />
          ...
          <circle cx="78" cy="20" r="3" fill="black" opacity="0.9" />
          <ellipse cx="74" cy="18" rx="3" ry="1.8" fill="black" opacity="0.9" transform="rotate(-30 74 18)" />
          <ellipse cx="82" cy="18" rx="3" ry="1.8" fill="black" opacity="0.9" transform="rotate(30 82 18)" />
          <ellipse cx="78" cy="16" rx="1.8" ry="3" fill="black" opacity="0.9" />
          <circle cx="78" cy="20" r="1.5" fill={BOT.body} opacity="0.25" />
          {/* Small buds */}
          <circle cx="16" cy="26" r="1.5" fill="black" opacity="0.8" />
          <circle cx="84" cy="26" r="1.5" fill="black" opacity="0.8" />
        </g>
      }
    />
  )
    ...
    <OutfitLayout
      ...
      onHead={
        <>
          ...
          <path d="M6 33 Q12 6 50 -2 Q88 6 94 33 Z" fill="black" opacity="0.9" />
          ...
          <path d="M38 4 L50 -14 L62 4 L58 2 L50 -8 L42 2 Z" fill="black" opacity="0.9" />
          <circle cx="50" cy="-14" r="3" fill="black" opacity="0.9" />
          <circle cx="50" cy="-14" r="1.2" fill={BOT.body} opacity="0.2" />
          {/* Brow guard — decorative band */}
          <rect x="4" y="30" width="92" height="6" rx="2" fill="black" opacity="0.9" />
          <path d="M10 33 L90 33" stroke={BOT.body} strokeWidth="0.4" opacity="0.12" />
          {/* Center mon crest on brow */}
          <circle cx="50" cy="33" r="4" fill="black" opacity="0.9" />
          <path d="M48 31 L50 29 L52 31 L50 35 Z" fill={BOT.body} opacity="0.2" />
          {/* Rivets on brow guard */}
          <circle cx="20" cy="33" r="1.2" fill="black" opacity="0.9" />
          <circle cx="20" cy="33" r="0.5" fill={BOT.body} opacity="0.2" />
          <circle cx="80" cy="33" r="1.2" fill="black" opacity="0.9" />
          <circle cx="80" cy="33" r="0.5" fill={BOT.body} opacity="0.2" />
          {/* Shikoro — layered neck guard flaps */}
          <path d="M4 36 L-2 48 L14 48 L18 36 Z" fill="black" opacity="0.9" />
          <path d="M0 42 L-4 52 L10 52 L14 42 Z" fill="black" opacity="0.85" />
          <path d="M82 36 L86 48 L102 48 L96 36 Z" fill="black" opacity="0.9" />
          <path d="M86 42 L90 52 L104 52 L100 42 Z" fill="black" opacity="0.85" />
          {/* Shikoro plate lines */}
    ...
    <OutfitLayout
      ...
      onHead={
        <>
          ...
          <path d="M8 50 Q4 16 50 -4 Q96 16 92 50 Z" fill="black" opacity="0.9" />
          {/* Hood side drapes extending down */}
          <path d="M8 50 Q6 60 4 70 L14 68 Q14 58 16 50 Z" fill="black" opacity="0.85" />
          <path d="M92 50 Q94 60 96 70 L86 68 Q86 58 84 50 Z" fill="black" opacity="0.85" />
          ...
          <path d="M46 78 L50 72 L54 78 L50 84 Z" fill="black" opacity="0.9" />
          <path d="M48 78 L50 74 L52 78 L50 82 Z" fill={BOT.body} opacity="0.15" />
          {/* Side tassels hanging from hood */}
          <path d="M14 68 L12 76 L16 76 L14 68 Z" fill="black" opacity="0.8" />
          <path d="M86 68 L84 76 L88 76 L86 68 Z" fill="black" opacity="0.8" />
        </>
      }
      ambient={
        <>
    ...
    <OutfitLayout
      ...
      onHead={
        <>
          ...
          <path d="M12 32 L18 18 L26 28 L34 14 L42 26 L50 8 L58 26 L66 14 L74 28 L82 18 L88 32 Z" fill="black" opacity="0.9" />
          {/* Crown base band */}
          <rect x="10" y="28" width="80" height="5" rx="2" fill="black" opacity="0.9" />
          ...
          <path d="M42 28 L50 6 L58 28 L50 38 Z" fill="black" opacity="0.9" />
          {/* Crystal facet lines */}
          ...
          {/* Side gems on band */}
          <path d="M18 28 L20 24 L22 28 L20 32 Z" fill="black" opacity="0.9" />
          <path d="M78 28 L80 24 L82 28 L80 32 Z" fill="black" opacity="0.9" />
    ...
    <OutfitLayout
      ...
      onHead={
        <>
          ...
          <path d="M4 52 Q2 16 50 4 Q98 16 96 52 Z" fill="black" opacity="0.9" />
          {/* Band padding detail */}
          ...
          <rect x="-2" y="42" width="14" height="20" rx="5" fill="black" opacity="0.9" />
          <rect x="0" y="44" width="10" height="16" rx="4" fill="black" opacity="0.9" />
          ...
          <rect x="88" y="42" width="14" height="20" rx="5" fill="black" opacity="0.9" />
          <rect x="90" y="44" width="10" height="16" rx="4" fill="black" opacity="0.9" />
          ...
          <path d="M0 62 Q4 68 8 72 L12 76" fill="none" stroke="black" strokeWidth="3" strokeLinecap="round" opacity="0.9" />
          <circle cx="4" cy="65" r="1.5" fill="black" opacity="0.9" />
          <circle cx="4" cy="65" r="0.6" fill={BOT.body} opacity="0.2" />
          {/* Mic capsule */}
          <rect x="9" y="73" width="8" height="6" rx="3" fill="black" opacity="0.9" />
          ...
          <line x1="96" y1="42" x2="98" y2="30" stroke="black" strokeWidth="2" strokeLinecap="round" opacity="0.9" />
          <circle cx="98" cy="30" r="1.5" fill="black" opacity="0.9" />
          <circle cx="98" cy="30" r="0.6" fill={BOT.body} opacity="0.25" />
          {/* Status LED on left ear */}
          <circle cx="1" cy="46" r="1" fill="black" opacity="0.9" />
