...
export function MotivationSection({
  ...
  return (
    <div className="mb-10 liquid-reveal section-fade-bg">
      ...
      <div className="flex gap-4 overflow-x-auto px-6 pr-24 lg:pr-6 pb-3 scrollbar-hide snap-row lg:grid lg:grid-cols-3 xl:grid-cols-4 lg:gap-5 lg:overflow-visible lg:pb-6">
        {(
