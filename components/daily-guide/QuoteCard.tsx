                  ...
                  <div className="flex items-center gap-1">
                    ...
                    >
                      <Heart className={`w-3.5 h-3.5 transition-colors ${
                        isFavorited ? 'text-pink-400 fill-pink-400' : isCompleted ? 'text-white/30' : 'text-white/50 hover:text-pink-400'
                      }`} />
                    </button>
                    <button
                      onClick={handleShare}
                      ...
                      title="Share quote"
                    >
                      <Share2 className={`w-3.5 h-3.5 ${isCompleted ? 'text-white/30' : 'text-white/50'} group-hover/share:text-white/80 transition-colors`} />
                    </button>
                  </div>
                </div>
              </div>
