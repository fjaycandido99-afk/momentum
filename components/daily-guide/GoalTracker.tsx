        ...
        <div className="p-4 pt-0 space-y-3">
          ...
          {completedGoals.map(goal => (
            <div key={goal.id} className="p-3 rounded-xl bg-emerald-500/5 border border-emerald-500/10 opacity-60">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-white/60 line-through">{goal.title}</span>
              </div>
            </div>
          ))}
          ...
          {showAddForm ? (
            ...
            <button
              ...
              className="w-full p-3 rounded-xl border border-dashed border-white/10 hover:border-white/20 text-white/40 hover:text-white/60 text-sm transition-colors flex items-center justify-center gap-2"
            >
