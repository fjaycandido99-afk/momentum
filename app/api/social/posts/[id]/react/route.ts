...
export async function POST(
  ...
  try {
    ...
    // Refuse the interaction if either party blocked the other.
    // 404 (not 403) so we don't leak the block existence to the
    // blocked user — they just see "Post not found".
