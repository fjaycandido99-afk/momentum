...
export async function GET(request: NextRequest) {
  try {
    ...
    if (date) {
      ...
      return NextResponse.json(guide || { date: targetDate, journal_win: null, journal_gratitude: null, journal_learned: null, journal_intention: null, journal_freetext: null, journal_mood: null, journal_prompt: null, journal_ai_reflection: null, journal_tags: [], journal_dream: null, journal_dream_interpretation: null, journal_conversation: null, morning_prime_done: false, midday_reset_done: false, wind_down_done: false, bedtime_story_done: false, mood_before: null, energy_level: null, daily_intention: null })
    }
