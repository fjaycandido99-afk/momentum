...
export const MINDSET_VISUALIZATIONS: Record<MindsetId, Visualization[]> = {
  ...
  manifestor: [
    {
      title: 'The Scene of the Wish Fulfilled',
      duration: '3 min',
      steps: [
        'Close your eyes. Take three deep breaths. Let your body relax completely.',
        'Think of one desire — something you truly want. Not the process of getting it, but the moment after it is already yours.',
        'Construct a short scene that would naturally happen if this desire were fulfilled. A congratulatory handshake. A view from your new home. A conversation with someone you love.',
        'Step into the scene. See it from first person — through your own eyes. Feel the textures, hear the sounds, notice the emotions rising in your body.',
        'Hold this scene. Loop it. Feel it as real. Neville taught: "Feeling is the secret." The more real it feels, the more powerfully it impresses your subconscious.',
        'When the feeling peaks, gently release the scene. Whisper "It is done." Open your eyes and carry the feeling into your day.',
      ],
    },
    {
      title: 'The Golden Light of Abundance',
      duration: '3 min',
      steps: [
        'Sit comfortably and close your eyes. Place your hands on your heart.',
        'Imagine a warm golden light forming in the center of your chest — this is your creative power, your ability to attract and receive.',
        'With each breath, the light grows brighter and warmer. It fills your entire body with a feeling of deep worthiness.',
        'Now imagine this golden light radiating outward — like a signal being broadcast. It reaches the people, opportunities, and circumstances that are meant for you.',
        'See these blessings moving toward you like lights on a horizon — drawn to your signal, finding their way to you naturally.',
        'Affirm silently: "I am a magnet for my highest good." Open your eyes gently. The signal is still broadcasting.',
      ],
    },
    {
      title: 'The Revision',
      duration: '2 min',
      steps: [
        'Close your eyes. Bring to mind one event from today or recently that did not go as you wished.',
        'See the event as it happened. Observe it without judgment — simply acknowledge it.',
        'Now rewrite the scene. Imagine it unfolding exactly as you would have wanted. Change the words spoken, the outcome, the feeling.',
        'Play the revised scene in your mind as if it were the real memory. Feel the relief, the satisfaction, the rightness of it.',
        'Neville taught that revision reprograms the subconscious. The revised version becomes the seed for future experiences.',
      ],
    },
    {
      title: 'The Feeling of Already Having',
      duration: '2 min',
      steps: [
        'Close your eyes. Choose one desire and ask yourself: "If this were already mine, how would I feel right now?"',
        'Do not visualize the thing itself — focus entirely on the emotion. Is it relief? Freedom? Excitement? Peace?',
        'Let that feeling fill your body. Breathe into it. Amplify it. This is not pretending — this is rehearsing your future state.',
        'Hold the feeling for as long as it feels natural. Wayne Dyer said: "You do not attract what you want. You attract what you are."',
        'Open your eyes. The feeling you just practiced is now your point of attraction. Return to it often throughout the day.',
      ],
    },
    {
      title: 'The Morning Alignment',
      duration: '3 min',
      steps: [
        'Before opening your eyes in the morning, lie still. Do not reach for your phone. Do not think about your to-do list.',
        'Ask yourself: "Who do I want to be today? What reality am I stepping into?"',
        'Imagine the day ahead as your ideal day — not perfect, but aligned. See yourself moving through it with confidence, ease, and magnetic energy.',
        'Feel gratitude for this day as if it has already been a success. Joe Dispenza teaches: "The best way to predict your future is to create it — not from the known, but from the unknown."',
        'Set one clear intention for the day. Speak it silently with conviction. Then open your eyes and begin as the person who already has what they desire.',
        'Carry this aligned feeling as your baseline. When you drift, return to it.',
      ],
    },
  ],
  hustler: [
    {
      ...
      duration: '3 min',
      steps: [
        'Close your eyes. Imagine yourself in a war room — maps on the walls, a single lamp burning. This is your command center.',
        'On the table in front of you are your goals — written clearly on cards. Pick up the most important one. Read it.',
        'Now visualize the battlefield. The obstacles between you and this goal are real. Name them: distraction, laziness, fear, comfort.',
        'You do not negotiate with these enemies. You plan your attack. What is the first strike? The second? The third?',
        'Feel the intensity of a person who has declared war on mediocrity. You are not hoping to win. You are refusing to lose.',
        'Open your eyes. You have your orders. Execute.',
      ],
    },
    {
      title: 'The 4:30 AM Decision',
      duration: '2 min',
      steps: [
        'Imagine it is 4:30 AM. The alarm sounds. The room is dark. Your bed is warm. Every part of you wants to stay.',
        'This is the moment that separates the talkers from the doers. Your body says no. Your mind says not today. But something deeper — your will — says get up.',
        'See yourself swinging your legs over the side of the bed. Feet on the cold floor. Standing up. The hardest part is over.',
        'Jocko says: "Discipline equals freedom." Every time you override comfort with commitment, you build the person you want to become.',
        'Open your eyes. You do not need it to be 4:30 AM. The principle is the same at any hour: choose the hard thing. Now.',
      ],
    },
    {
      ...
      duration: '3 min',
      steps: [
        'Close your eyes. Imagine yourself standing before a mirror — but this mirror shows the truth. No filters. No excuses.',
        'Look at the person staring back. Ask them: "Are you doing everything you can? Are you living up to your potential? Or are you coasting?"',
        'Listen to the answer. It may be uncomfortable. That discomfort is the beginning of growth.',
        'Now imagine sticky notes on the mirror — each one a truth about where you are falling short. Read them without flinching.',
        'Pick one. Commit to destroying that weakness today. Not tomorrow. Not next week. Today.',
        'Open your eyes. Goggins built his life on the accountability mirror. Be honest. Then be relentless.',
      ],
    },
    {
      ...
      duration: '2 min',
      steps: [
        'Close your eyes. Imagine your mind as a pair of hands — soft, uncalloused, sensitive to pain.',
        'Now recall every hard thing you have done — every workout you finished, every rejection you survived, every time you kept going. Each one is friction that builds calluses.',
        'Feel your mental hands becoming tougher. Not numb — just stronger. Able to grip harder. Able to hold on longer.',
        'Goggins says: "You have to build calluses on your brain just like you build calluses on your hands." The only way is through repeated discomfort.',
        'Open your eyes. Today, seek one moment of productive discomfort. Add another layer to the callus.',
      ],
    },
    {
      ...
      duration: '3 min',
      steps: [
        'At the end of your day, close your eyes. Replay the day like a mission debrief.',
        'What was the objective? What did you accomplish? Where did you execute with discipline and focus?',
        'Now the hard part: where did you slack? Where did you make excuses? Where did you choose comfort over growth?',
        'Do not beat yourself up — that is wasted energy. Instead, extract the lesson. Jocko calls this "getting better, not bitter."',
        'Set one adjustment for tomorrow. One thing you will do differently. Write it down.',
        'Open your eyes. The person who reviews their day honestly is the person who wins the war of improvement.',
      ],
    },
  ],
}
